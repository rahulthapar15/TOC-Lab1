...
- [ ] Implement string matching using Finite Automata as given in Cormen book pg. no. 995.
        ...
        - [x] Take a string as an input from user and see whether the pattern exists or not using the transition table created in first step.
        - [x] Count the number of occurences and the position of the pattern in the string
